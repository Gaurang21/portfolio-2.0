...
const metrics = [
  {
    ...
    prefix: "",
    suffix: "+",
    label: "Customer IoT Networks",
    description: "Cisco Meraki IoT deployed across after ground-up platform rebuild",
  ...
  },
  {
    ...
    description: "Resolution time reduced by RAG-powered AI agents across time zones",
  ...
  },
  {
    ...
    suffix: "%",
    label: "Test Coverage",
    description: "Maintained on IoT platform rebuild — because that's how I sleep at night",
  ...
  },
  {
    ...
    description: "Allocation time reduced via AWS SES reporting automation",
  ...
  },
  {
    ...
    description: "Shipping production systems across IoT, SaaS, telecom, and healthcare",
...
function Counter({
  ...
  const [count, setCount] = useState(value <= 10 ? value : 0);
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true });

  useEffect(() => {
    if (!isInView || value <= 10) return;
    const duration = 2000;
    const steps = 60;
