...
const experiences = [
  {
    ...
    bullets: [
      "Architected and led a complete rebuild of Cisco Meraki IoT Radio Settings over six months, replacing an architecture that locked every Access Point to a single technology with one that lets each AP run its own (Bluetooth, Zigbee, or ESL) — deployed across 1,000+ customer IoT networks at 90% test coverage",
      "Designed a data migration service with zero downtime that automatically synced legacy IoT configurations into the new data model via a background job queue, moving the entire customer base with no service disruption",
      ...
      "Built an interactive Cisco Spaces web application with React and Mapbox rendering custom indoor building maps that automatically compute optimal Access Point placement across large campuses, cutting deployment from days to minutes",
      "Drove the Zigbee door lock feature to General Availability and integrated third-party ESL hardware, opening new hospitality and retail customer segments",
    ],
  ...
  },
  {
    ...
    location: "San Jose, CA",
    bullets: [
      "Migrated supplier metrics from Quickbase to Jira with Python, saving $25K/year in licensing, and automated reporting with Python and AWS SES that cut staff allocation time 10%; built a React and Python portal feeding live Tableau dashboards",
    ],
